...
Too Good To Go (Đan Mạch, ra mắt năm 2016) cho phép các nhà hàng và siêu thị bán túi thực phẩm dư cuối ngày với giá giảm sâu cho người tiêu dùng gần đó~\cite{TooGoodToGo}. Đây là mô hình thương mại — người nhận vẫn phải trả tiền để lấy thực phẩm — nên không phục vụ được nhóm đối tượng khó khăn không có khả năng chi trả.

OLIO (Anh, ra mắt năm 2015) là nền tảng chia sẻ cộng đồng phi lợi nhuận, cho phép cá nhân đăng và nhận thực phẩm miễn phí trong phạm vi lân cận~\cite{Olio}. Tuy hoạt động theo mô hình cá nhân với cá nhân, OLIO lại không có cơ chế phối hợp vận chuyển và không hỗ trợ vai trò tình nguyện viên giao nhận chuyên biệt.

Tại Việt Nam, các giải pháp hiện có vẫn chủ yếu mang tính thủ công và phi chính thức: các nhóm ``giải cứu thực phẩm'' hoạt động qua Facebook/Zalo, các tổ chức như Foodbank Vietnam điều phối bằng điện thoại và gặp mặt trực tiếp, các bếp ăn 0 đồng hoạt động theo giờ cố định. Qua khảo sát thực tế, tôi nhận thấy hiện chưa có ứng dụng di động chuyên biệt nào được triển khai rộng rãi tại Việt Nam để giải quyết toàn diện bài toán kết nối chia sẻ thực phẩm theo thời gian thực.
...
(i) Thứ nhất, chưa có giải pháp nào triển khai mô hình ba vai trò đầy đủ — người cho, người nhận, tình nguyện viên vận chuyển — với cơ chế phối hợp tự động theo thời gian thực. Các giải pháp hiện tại hoặc bỏ qua vai trò vận chuyển (OLIO, Too Good To Go), hoặc xử lý thủ công (Foodbank Vietnam).
...
(iii) Về luồng nghiệp vụ hai chiều, ứng dụng cần cho phép cả hai hướng: người cho đăng thực phẩm sẵn có và người nhận chủ động đăng yêu cầu thực phẩm cụ thể — từ đó nền tảng có thể điều phối kết nối giữa hai phía.
...
Đề tài được giới hạn trong phạm vi sau đây. Về nền tảng, ứng dụng dành cho người dùng cuối được phát triển cho thiết bị di động chạy hệ điều hành Android, kèm một cổng quản trị trên nền web phục vụ quản trị viên. Về tác nhân, hệ thống phục vụ bốn vai trò gồm người cho, người nhận, tình nguyện viên vận chuyển và quản trị viên. Về nghiệp vụ, đề tài giải quyết luồng chia sẻ thực phẩm theo hai chiều, gồm người cho đăng thực phẩm dư và người nhận đăng yêu cầu thực phẩm, kèm điều phối vận chuyển trong phạm vi địa lý giới hạn và cơ chế xác nhận giao nhận. Về thử nghiệm, hệ thống được kiểm thử với dữ liệu mô phỏng tại khu vực đô thị mà điển hình là Hà Nội. Một số nội dung nằm ngoài phạm vi đề tài, bao gồm cổng thanh toán trực tuyến, tích hợp với các đơn vị vận chuyển thương mại và việc phát hành chính thức trên kho ứng dụng.
...
Để giải quyết các nhiệm vụ xác định ở mục~\ref{section:1.2}, đề tài tiếp cận theo các định hướng công nghệ và kỹ thuật sau:

(i) Phát triển ứng dụng di động đa nền tảng (Cross-platform Mobile Development). Đề tài sử dụng framework React Native kết hợp với Expo — cho phép xây dựng một mã nguồn duy nhất chạy trên Android. 
...
(iii) Dữ liệu được lưu trữ trên MongoDB — cơ sở dữ liệu NoSQL lưu trữ theo dạng tài liệu JSON linh hoạt.

(iv) Kết nối dựa trên vị trí địa lý. Khoảng cách giữa người cho và người nhận được ước lượng bằng Google Distance Matrix API, kèm thuật toán Haversine làm phương án dự phòng, nhằm ưu tiên gợi ý những đơn ở gần người dùng nhất.
...
Dựa trên định hướng công nghệ nêu trên, giải pháp được đề xuất là một hệ thống ứng dụng di động đa nền tảng kết hợp cổng quản trị website, phục vụ bài toán kết nối chia sẻ thực phẩm dư thừa tại Việt Nam.
...
\begin{figure}[H]
    ...
    \caption{Luồng nghiệp vụ chia sẻ thực phẩm --- chiều từ người cho}
    \label{fig:luong_tu_nguoi_cho}
\end{figure}

Hình~\ref{fig:luong_tu_nguoi_cho} mô tả sơ bộ luồng nghiệp vụ quyên tặng thực phẩm từ phía người cho: người cho (Donor) đăng bài muốn quyên tặng thực phẩm, người nhận (Receiver) thấy bài đăng và kết nối. Sau khi kết nối, người nhận chọn tự đến lấy hoặc ủy thác cho tình nguyện viên (Volunteer) đến nhận. Sau khi nhận được thực phẩm từ người cho, người nhận xác nhận hoàn tất.
...
Hình~\ref{fig:luong_tu_nguoi_nhan} mô tả sơ bộ luồng nghiệp vụ yêu cầu thực phẩm từ phía người nhận: người nhận (Receiver) đăng bài yêu cầu, người cho (Donor) thấy và đáp ứng yêu cầu, sau đó người nhận chọn tự đến lấy hoặc ủy thác cho tình nguyện viên (Volunteer) đến nhận. Sau khi nhận được thực phẩm từ người cho, người nhận xác nhận hoàn tất.

\subsection{Đóng góp và kết quả đạt được}
\label{subsection:1.3.3}

Đóng góp chính của đề tài là một hệ thống chia sẻ thực phẩm hoàn chỉnh, kết hợp đồng thời ba đặc trưng mà các giải pháp hiện có còn thiếu: (i) mô hình ba vai trò người cho, người nhận và tình nguyện viên với cơ chế điều phối vận chuyển bán tự động theo nguyên tắc ``ai nhận trước được trước''; (ii) luồng nghiệp vụ hai chiều, cho phép người nhận chủ động đăng yêu cầu thực phẩm bên cạnh luồng người cho đăng thực phẩm dư; và (iii) các cơ chế bảo đảm tin cậy gồm mã xác nhận lấy hàng chống giao nhận sai người, quy trình xác nhận hai bước chống khai khống đã giao, và hệ thống điểm thưởng ghi nhận đóng góp.
...
\label{section:1.4}
Để trình bày một cách khoa học và hệ thống, phần còn lại của báo cáo đồ án tốt nghiệp này được tổ chức như sau.
...
\textbf{\MakeUppercase{Chương 3: Nền tảng lý thuyết và công nghệ sử dụng}}: Nội dung chương trình bày và phân tích các nền tảng lý thuyết cùng công nghệ được sử dụng trong đề tài, bao gồm framework phát triển ứng dụng di động đa nền tảng React Native và Expo, nền tảng máy chủ Node.js với Express, cơ sở dữ liệu NoSQL MongoDB, cơ chế giao tiếp thời gian thực qua WebSocket, cùng các kỹ thuật định vị địa lý và xác thực người dùng. Với mỗi công nghệ, chương làm rõ vai trò trong việc giải quyết các yêu cầu đã nêu ở Chương 2 và lý do lựa chọn so với các phương án thay thế.

\textbf{\MakeUppercase{Chương 4: Phân tích thiết kế, triển khai và đánh giá hệ thống}}: Nội dung chương trình bày kiến trúc tổng thể của hệ thống và thiết kế chi tiết gồm thiết kế giao diện, thiết kế lớp và thiết kế cơ sở dữ liệu; tiếp đó là quá trình xây dựng ứng dụng với các thư viện, công cụ sử dụng và minh họa các chức năng chính; cuối cùng là hoạt động kiểm thử và triển khai hệ thống.

\textbf{\MakeUppercase{Chương 5: Các giải pháp và đóng góp nổi bật}}: Nội dung chương phân tích sâu các giải pháp và đóng góp nổi bật của đề tài, mỗi đóng góp được trình bày theo trình tự bài toán đặt ra, giải pháp và kết quả đạt được.

\textbf{\MakeUppercase{Chương 6: Kết luận và hướng phát triển}}: Nội dung chương so sánh sản phẩm của tôi với các ứng dụng tương tự, tổng kết những gì tôi đã làm được trong suốt quá trình thực hiện đồ án tốt nghiệp, nêu ra những kinh nghiệm và bài học rút ra, đồng thời đưa ra các định hướng cần thiết để hoàn thiện và phát triển các chức năng đã làm.
