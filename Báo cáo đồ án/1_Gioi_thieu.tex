...
Tại Việt Nam, các giải pháp hiện có vẫn chủ yếu mang tính thủ công và phi chính thức: các nhóm "giải cứu thực phẩm" hoạt động qua Facebook/Zalo, các tổ chức như Foodbank Vietnam điều phối bằng điện thoại và gặp mặt trực tiếp, các bếp ăn 0 đồng hoạt động theo giờ cố định. Theo khảo sát thực tế của bản thân em, chưa có ứng dụng di động chuyên biệt nào được triển khai rộng rãi tại Việt Nam để giải quyết toàn diện bài toán kết nối chia sẻ thực phẩm theo thời gian thực.
...
(iv) Kết nối dựa trên vị trí địa lý. Khoảng cách giữa người cho và người nhận được tính theo hai mức: thuật toán Haversine (khoảng cách đường chim bay) làm phương án dự phòng, và Google Distance Matrix API (khoảng cách đường bộ thực tế) làm phương án chính khi có kết nối. 
...
\subsection{Mô tả ngắn gọn giải phápp}
...
\begin{figure}[h]
    ...
    \caption{Chiều từ người cho}
    \label{fig:luong_tu_nguoi_cho}
\end{figure}

Hình \ref{fig:luong_tu_nguoi_cho} mô tả sơ bộ luồng nghiệp vụ quyên tặng đồ ăn từ người cho : Người cho (donor) đăng bài muốn quyên tặng thực phẩm, người nhận (receiver) thấy bài đăng và kết nối. Sau khi kết nối,người nhận (receiver) chọn tự nhận hoặc ủy quyền cho tình nguyện viên (volunteer) đến nhận. Sau khi nhận được đồ ăn từ người cho (donor), người nhận (receiver) xác nhận hoàn tất.

\begin{figure}[h]
    \centering
    \chaptergraphic[width=0.9\textwidth]{Hinhve/Gioithieu/Luong_tu_nguoi_nhan.png}
    \caption{Chiều từ người nhận}
    \label{fig:luong_tu_nguoi_nhan}
\end{figure}

Hình \ref{fig:luong_tu_nguoi_nhan} mô tả sơ bộ luồng nghiệp vụ yêu cầu đồ ăn từ người nhận (receiver): người nhận (receiver) đăng bài yêu cầu, người cho (donor) thấy và đáp ứng yêu cầu, người nhận (receiver) chọn tự nhận hoặc ủy quyền cho tình nguyện viên (volunteer) đến nhận. Sau khi nhận được đồ ăn từ người cho (donor), người nhận (receiver) xác nhận hoàn tất.


\section{Bố cục đồ án}%
\label{section:1.4}
Để trình bày một cách lô gic và khoa học, phần còn lại của báo cáo đồ án tốt nghiệp này được tổ chức như sau.

\textbf{\MakeUppercase{Chương 2: Khảo sát và phân tích yêu cầu}}: Nội dung chương tập trung về khảo sát chi tiết về các ứng dụng tương tự.Mô tả tổng quan chức năng của hệ thống thông qua các biểu đồ usecase tổng quát, phân rã. Trình bày chi tiết về quy trình nghiệp vụ. Đồng thời đặc tả chức năng thông qua đặc tả usecase.
...
\textbf{\MakeUppercase{Chương 4: Phân tích thiết kế, triền khai và đánh giá hệ thống}}: Nội dung chương trình bày về kiến trúc hệ thống, thiết kế giao diện. Thư viện, công cụ sử dụng và minh họa các chức năng chính.

\textbf{\MakeUppercase{Chương 5: Các giải pháp và đóng góp nổi bật}}: Nội dung chương trình bày giải pháp và các đóng góp mà tôi cho rằng nổi bật. 

\textbf{\MakeUppercase{Chương 6:Kết luận và hường phát triển}}: Nội dung chương gồm phần so sánh sản phẩm của mình đối với các ứng dụng tương tự. Đồng thời tổng kết lại rằng mình đã làm được gì trong suốt quá trình thực hiện đồ án tốt nghiệp. Nêu ra những kinh nghiệm, bài học đạt được. Bên cạnh đó, cũng đưa ra định hướng cần thiết để hoàn thiện các chức năng đã làm.
